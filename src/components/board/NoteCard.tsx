...
export function NoteCard({ note, onClick, onDelete }: NoteCardProps) {
  ...
  return (
    <div
      className="bg-white dark:bg-stone-800 rounded-xl p-5 cursor-pointer shadow-sm dark:shadow-stone-950/20 hover:shadow-md dark:hover:shadow-stone-950/30 hover:-translate-y-0.5 transition-all duration-200 break-inside-avoid mb-4 group"
      onClick={onClick}
    >
      {note.title && (
      ...
      <div className="flex justify-end mt-3 -mb-1 -mr-1">
        <button
